...
<template>
  <form
    class="relative overflow-hidden rounded-2xl border border-black/10 bg-white/95 p-6 shadow-[0_45px_85px_-45px_rgba(14,20,48,0.55)] backdrop-blur-2xl transition-colors duration-300 dark:border-white/10 dark:bg-zinc-900/70 md:p-8"
    @submit.prevent
  >
    <div
      aria-hidden="true"
    ...
    <div class="relative z-[1] space-y-6">
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <UButton type="submit" size="lg" icon="i-heroicons-sparkles-20-solid" class="group">
          Send the vision
